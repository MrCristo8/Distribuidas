<%-- 
    ...
    Created on : Jan 27, 2019, 11:05:07 AM
    Author     : csrm1
--%>
            ...
            <div class=container-fluid>
                <div class=row>
                    <div class=col-md-12>
                        ...
                        <br><br>
                        <form  action="/CR_WB_WebPage/InventoryInsert" method="post">
                            <input type="hidden" name="inventory_id" value="${inventory_id}"/>                            
                            <div class="form-row">                                
                                <div class="col">
                                    <label for="inventory_date">Inventory Date</label>
                                    <input id="inventory_date" name ="inventory_date" type="date" class="form-control">
                                </div>
                                <div class="col">
                                    <label for="movement">Movement Name</label>
