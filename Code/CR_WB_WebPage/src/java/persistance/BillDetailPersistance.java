...
public class BillDetailPersistance
{
    ...
    private Contract<model.WB_CR_BILLDETAIL> iface;
    private ArrayList<model.WB_CR_BILLDETAIL> object_list;
    ...
    private BillDetailPersistance()
    {
        try
        {
            ...
            iface = (Contract) reg.lookup("rmi://" + util.Strings.IP + ":1099/BillDetailAPI");
    ...
    public ArrayList<model.WB_CR_BILLDETAIL> getObjectList()
    {
