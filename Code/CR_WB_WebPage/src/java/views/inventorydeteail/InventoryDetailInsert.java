 ...
 * @author csrm1
 */
@WebServlet(name = "InventoryDetailInsert", urlPatterns = {"/InventoryDetailInsert"})
public class InventoryDetailInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InventoryDetailInsert</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InventoryDetailInsert at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            WB_CR_INVENTORY_DETAIL detail_entry = new WB_CR_INVENTORY_DETAIL(inventory_id, article_id, detail_ammount, "CREATED");
            WB_CR_ARTICLE article = new WB_CR_ARTICLE(article_id);
            ...
            logic.TempArrays.getInstance().getTempInventoryDetailArr().add(detail_entry);
