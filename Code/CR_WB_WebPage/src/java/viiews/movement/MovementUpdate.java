 ...
 * @author csrm1
 */
@WebServlet(name = "MovementUpdate", urlPatterns =
{
    "/MovementUpdate"
})
public class MovementUpdate extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        request.setAttribute("movement", persistance.MovementPersistance.getInstance().getObjectList().get(pos));
            ...
            throws ServletException, IOException
    {
        ...
        } else
        {
            ...
            response.sendRedirect("/CR_WB_WebPage/MovementUpdate?movement_id=" + id);
        }
    }
